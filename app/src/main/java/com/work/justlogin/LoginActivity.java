...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public boolean PostToApi(){
        ...
        retrofitAPIInterface.insertUser(

                //Passing the values by getting it from editTexts
                mEmailView.getText().toString(),
                mPasswordView.getText().toString(),
                //Creating an anonymous callback
                new Callback<Response1>() {
                    ...
                    public void onFailure(Call<Response1> call, Throwable t) {
                        Toast.makeText(LoginActivity.this, "Login Failed, Please check network connection!!", Toast.LENGTH_LONG).show();
                    }
                }
        );
        return success[0];
